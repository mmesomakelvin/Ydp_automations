// Status/tone helpers for Mentor Lookup (self-contained for portability).
...
export function statusBadge(match: MenteeMatch): Badge {
...
export function riskBadge(match: MenteeMatch): Badge | null {
